...
<p class="text-center font-weight-bold h5"> Wahh!! Anda Belum Melakukan Absensi Hari Ini!!</p><br>
        <a href="<?php echo base_url().'ketua_kecamatan/absen_sekarang' ?>" class='btn btn-outline-primary col-sm-4 row-sm-4'><i class="fa fa-hand-paper-o"></i> Absensi Sekarang</button><a>
