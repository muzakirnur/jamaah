<div class="container">
  <div class="card">
    ...
    <div class="card-body">
      <a href="<?php echo base_url().'ketua_kecamatan/absen_isi' ?>" class='btn btn-sm btn-light btn-outline-dark pull-right'><i class="fa fa-arrow-left"></i> Kembali</a>
      
      <br/>
      <br/>

      <form method="post" action="<?php echo base_url().'ketua_kecamatan/absen_aksi'; ?>">
