  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      if(isset($_GET['tanggal_mulai']) && isset($_GET['tanggal_sampai'])){
        ...
        ?>
        <a class='btn btn-primary' target="_blank" href='<?php echo base_url().'ketua_kecamatan/pengajian_cetak/?tanggal_mulai='.$mulai.'&tanggal_sampai='.$sampai ?>'><i class='fa fa-print'></i> CETAK</a>
        <?php
      }
      ?>
      <br/>
