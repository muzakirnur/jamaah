...
<h5>Wali Kelas      : <?php echo $p->wali; ?><h5>
    ...
    <a href="<?php echo base_url().'ketua_kecamatan/pilah_kembalikan' ?>" class='btn btn-sm btn-light btn-outline-danger pull-right'><i class="fa fa-history"></i> Kembalikan Jamaah</a>
          ...
          foreach($anggota as $p){
            ...
            <td><?php echo $p->no_anggota; ?></td>
              ...
              <td class="text-center">
                ...
                if($p->id_kelas=='1'){
                  echo "-";
                }else if($p->id_kelas=='3' ){
                  echo "-";
                }else if($p->id_kelas=='4' ){
                  echo "-";
                }else if($p->id_kelas=='5' ){
                  echo "-";
                }
                else if($p->id_kelas=='0' ){
                  ?>
                  <a href="<?php echo base_url().'ketua_kecamatan/pilah_tambahkan/'.$p->id; ?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambahkan</a>
                  <?php      
                } 
                ?>
