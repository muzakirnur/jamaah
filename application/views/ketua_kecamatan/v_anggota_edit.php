  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <?php foreach($anggota as $a){ ?>
        <form method="post" action="<?php echo base_url().'ketua_kecamatan/anggota_update'; 
     ...
     <?php
                ...
                ?>
                  ...
                  <a href="<?php echo base_url().'peringatan/minta_peringatan/'.$a->id; ?>" class='btn btn-sm btn-warning pull-left'><i class="fa fa-chalkboard-teacher"></i> Minta Surat Peringatan</a>
                  </div>              

        <?php  
                }elseif($a->peringatan == "1"){
            ?>
                  <div class="form-group ">
                  <div class="card bg-warning mx-3  pull-left d-inline " style="max-width: 100rem;"> Di Minta</div>        
                  </div>

                  <?php  
                }elseif($a->peringatan == "2"){
            ?>
                  <div class="form-group">
                  <a href="<?php echo base_url().'peringatan/export_pdf/'.$a->id; ?>" class='btn btn-sm btn-warning pull-left'><i class="fa fa-download"></i> Surat Peringatan</a>
                  </div>       
          <?php  
                }
            ?>
...
<?php
                if($a->pemberhentian == "0"){
                
                ?>
                  <div class="form-group">
                  <a href="<?php echo base_url().'pemberhentian/minta_pemberhentian/'.$a->id; ?>" class='btn btn-sm btn-danger pull-left'><i class="fa fa-chalkboard-teacher"></i> Minta Surat pemberhentian</a>
                  </div>              

        <?php  
                }elseif($a->pemberhentian == "1"){
            ?>
                  <div class="form-group ">
                  <div class="card bg-danger mx-3  pull-left d-inline " style="max-width: 100rem;"> Di Minta</div>        
                  </div>

                  <?php  
                }elseif($a->pemberhentian == "2"){
            ?>
                  <div class="form-group">
                  <a href="<?php echo base_url().'pemberhentian/export_pdf/'.$a->id; ?>" class='btn btn-sm btn-danger pull-left'><i class="fa fa-download"></i> Surat Pengeringatan</a>
                  <a href="<?php echo base_url().'pemberhentian/hapus_anggota/'.$a->id; ?>" class='btn btn-sm btn-danger pull-left'><i class="fa fa-chain-broken"></i> Keluarkan Anggota</a>
...
<input type="hidden"  name="id" value="<?php echo $a->id; ?>">
       <div class="row">
						...
						<input type="hidden" class="form-control text-center" name='no_anggota2' readonly value='<?php echo $a->no_anggota; ?>'>
