<div class="container-fluid">
  <div class="card ">
    <div class="card-header text-center">
      <h4>Pengeluaran Surat Peringatan</h4>
      </div>
    <div class="card-body ">
          ...
          <tbody>
            ...
            foreach($peringatan as $p){
              ...
              <td><?php echo $no++; ?></td>
                ...
                <td> <a href="<?php echo base_url().'admin/terima_peringatan/'.$p->id; ?>" class="btn btn-sm btn-primary"><i class="fa fa-check"></i></a></td>
                <td> <a href="<?php echo base_url().'admin/tolak_peringatan/'.$p->id; ?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a></td>
