...
class PDF extends FPDF{
    ...
    function Header(){
        if ($this->PageNo() == 1){
            ...
            $this->cell(100,6,'Laporan Data Anggota Per Majelis ',0,1,'L',1); 
...
//            $this->Line(10,$this->GetY(),200,$this->GetY());
    ...
    function Content($anggota, $kelas){
        $ya = 46;
        $rw = 6;
        $no = 1;
        ...
        foreach ($anggota as $key) {
          ...
          $this->cell(30,10,$key->nama_ortu,1,0,'C',1);
          ...
          $this->cell(24,10,$key->kabupaten,1,1,'C',1);
          $ya = $ya + $rw;
          $no++;
