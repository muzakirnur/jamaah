...
class PDF extends FPDF{
    ...
    function Header(){
        if ($this->PageNo() == 1){
            ...
            $this->cell(100,6,'Laporan Data Kehadiran Ketua Kelas',0,1,'L',1); 
            $this->cell(25,6,'',0,0,'C',0); 
            ...
            $this->cell(25,10,'HP',1,0,'C',1);
            $this->cell(15,10,'KELAS',1,0,'C',1);
            $this->cell(30,10,'GAMPONG',1,0,'C',1);
            $this->cell(24,10,'KECAMATAN',1,0,'C',1);
            $this->cell(24,10,'JAM',1,0,'C',1);
            $this->cell(24,10,'TANGGAL',1,1,'C',1);

        }else{
            $this->setFont('Arial','I',9);
            $this->setFillColor(255,255,255);
            $this->cell(90,6,'Laporan Data Kehadiran Ketua Kelas',0,1,'L',1); 
            $this->cell(100,6,"Printed date : " . date('d-M-Y'),0,1,'R',1); 
//            $this->Line(10,$this->GetY(),200,$this->GetY());
            $this->Ln(2);
            $this->setFont('Arial','B',9);
    ...
    function Content($kehadiran){
        ...
        foreach ($kehadiran as $key) {
            ...
            $this->setFillColor(255,255,255);	
            $this->cell(10,10,$no,1,0,'C',1);
            $this->cell(15,10,$key->id_ketua_kelas,1,0,'C',1);
            $this->cell(30,10,$key->nama,1,0,'C',1);
            $this->cell(25,10,$key->hp,1,0,'C',1);
            $this->cell(15,10,$key->kelas,1,0,'C',1);
            $this->cell(30,10,$key->gampong,1,0,'C',1);
            $this->cell(24,10,$key->kecamatan,1,0,'C',1);
            $this->cell(24,10,$key->jam,1,0,'C',1);
            $this->cell(24,10,$key->tanggal,1,1,'C',1);
            $ya = $ya + $rw;
            $no++;
