...
//            $this->Line(10,$this->GetY(),200,$this->GetY());
            ...
            $this->cell(10,10,'N.A.',1,0,'C',1);
            $this->cell(25,10,'Nama ',1,0,'C',1);
            $this->cell(25,10,'Nama Ortu ',1,0,'C',1);
            $this->cell(25,10,'Tanggal ',1,0,'C',1);
            $this->cell(20,10,'Jam ',1,0,'C',1);
            $this->cell(15,10,'Hari ',1,0,'C',1);
            $this->cell(40,10,'Ket Pengajian',1,0,'C',1);
    ...
    function Content($absensi, $kelas){
        ...
        foreach ($absensi as $key) {
            ...
            $this->cell(25,10,$key->nama,1,0,'C',1);
                        $this->cell(25,10,$key->nama_ortu,1,0,'C',1);
            ...
            $this->cell(40,10,$key->ket_pengajian,1,0,'C',1);
