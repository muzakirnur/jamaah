  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      if(isset($_GET['tanggal_mulai']) && isset($_GET['tanggal_sampai'])&& isset($_GET['id_gampong'])){
        ...
        ?>
        <a href="<?php echo base_url().'meninggal/export_pdf_meninggal_admin/?tanggal_mulai='.$mulai.'&tanggal_sampai='.$sampai.'&gampong='.$gampong?>" class='btn btn-sm btn-warning pull-right'><i class="fa fa-print"></i> Print Data</a>
        <?php
      }
      ?>
      <br/>
