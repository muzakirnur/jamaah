            ...
            <td><?php echo $no++; ?></td>
              ...
              <td class="text-center">
                ...
                if($p->absen=='1'){
                  ...
                  ?>
                  <a href="<?php echo base_url().'admin/absen_sakit/'.$p->absensi_id; ?>" class="btn btn-sm btn-secondary"><i class="fa fa-thermometer-quarter "></i> Sakit</a>
                  <a href="<?php echo base_url().'admin/absen_izin/'.$p->absensi_id; ?>" class="btn btn-sm btn-warning"><i class="fa fa-car"></i> Izin</a>
                  <a href="<?php echo base_url().'admin/absen_masuk/'.$p->absensi_id; ?>" class="btn btn-sm btn-success"><i class="fa fa-hand-paper-o "></i> Masuk</a>
                  <a href="<?php echo base_url().'admin/absen_alpa/'.$p->absensi_id; ?>" class="btn btn-sm btn-danger"><i class="fa fa-eye-slash"></i> Alpa</a>
                  <?php
                }
