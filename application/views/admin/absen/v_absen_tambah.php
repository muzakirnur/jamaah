<div class="container">
  <div class="card">
    ...
    <div class="card-body">
      <a href="<?php echo base_url().'admin/absen_isi' ?>" class='btn btn-sm btn-light btn-outline-dark pull-right'><i class="fa fa-arrow-left"></i> Kembali</a>
      
      <br/>
      <br/>

      <form method="post" action="<?php echo base_url().'admin/absen_aksi'; ?>">
  ...
  <div class="form-group">
          ...
          <input type="hidden" name="gampong" value='<?php echo $this->session->userdata('gampong'); ?>'>
        ...
        <div class="form-group">
          ...
          <input type="hidden" value='' class="form-control" name="gampong"  >
