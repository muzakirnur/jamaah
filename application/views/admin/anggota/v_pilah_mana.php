...
<h5>Wali Kelas      : <?php echo $p->wali; ?><h5>
    ...
    <a href="<?php echo base_url().'admin/pilah_kembalikan' ?>" class='btn btn-sm btn-light btn-outline-danger pull-right'><i class="fa fa-history"></i> Kembalikan Jamaah</a>
            ...
            <td><?php echo $p->no_anggota; ?></td>
              ...
              <td class="text-center">
                ...
                if($p->id_kelas=='1'){
                  ...
                  ?>
                  <a href="<?php echo base_url().'admin/pilah_tambahkan/'.$p->id; ?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambahkan</a>
                  <?php      
                } 
                ?>
