        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="id" class="col-sm-2 col-form-label">No.BP</label>
                    <div class="col-sm-4">
                        <input type="text" name="id" id="id" class="form-control" maxlength="7" readonly
                            value="<?= $id ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="id" class="col-sm-2 col-form-label">Tempat Lahir</label>
                    <div class="col-sm-6">
                        <input type="text" name="tempat" id="tempat" class="form-control" value="<?= $tempat ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="id" class="col-sm-2 col-form-label">Tgl.Lahir</label>
                    <div class="col-sm-4">
