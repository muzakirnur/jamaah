...
<h5>Wali Kelas      : <?php echo $p->wali; ?><h5>
    ...
    <a href="<?php echo base_url().'admin/pilah_mana' ?>" class='btn btn-sm btn-light btn-outline-success pull-right'><i class="fa fa-plus"></i> Tambahkan Jamaah</a>
      ...
      <table class="table table-bordered text-center table-striped table-hover table-datatable">
        ...
        <tbody>
          ...
          foreach($anggota as $p){
            ...
            if($p->id_kelas !='0' ){
                  ?>
                  <a href="<?php echo base_url().'admin/pilah_kembali/'.$p->id; ?>" class="btn btn-sm btn-danger"><i class="fa fa-history"></i> Kembalikan</a>
                  <?php      
                } 
                ?>
