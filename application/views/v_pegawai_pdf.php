...
class PDF extends FPDF{
    ...
    function Header(){
        if ($this->PageNo() == 1){
            ...
            $this->cell(100,6,'Laporan Data Anggota',0,1,'L',1); 
            $this->cell(25,6,'',0,0,'C',0); 
            ...
            $this->cell(25,10,'KABUPATEN',1,1,'C',1);
...
//            $this->Line(10,$this->GetY(),200,$this->GetY());
    ...
    function Content($sSQL){
        ...
        foreach ($sSQL as $key) {
            ...
            $this->cell(15,10,$key->nip,1,0,'C',1);
            $this->cell(30,10,$key->nip,1,0,'C',1);
            $this->cell(30,10,$key->nip,1,0,'C',1);
            $this->cell(25,10,$key->nip,1,0,'C',1);
            $this->cell(10,10,$key->nip,1,0,'C',1);
            $this->cell(25,10,$key->nip,1,0,'C',1);
            $this->cell(25,10,$key->nip,1,0,'C',1);
            $this->cell(25,10,$key->nip,1,1,'C',1);
            $ya = $ya + $rw;
            $no++;
        }            
    }
