 ...
 <div class="row mt-2">
            <div class="col-12">
                <div class="card-inline">
                    ...
                    <a href="<?php echo base_url().'kelas/meninggal_laporan' ?>" class='btn btn-sm btn-warning pull-right'><i class="fa fa-file-pdf-o "></i> Rekap Data Jamaah Meninggal</a>
                </div>
      <br/>
      <br/>
        ...
        <tbody>
          ...
          foreach($anggota as $a){
            ...
            <tr>
              ...
              <td>
              <a href="<?php echo base_url().'kelas/anggota_meninggal_edit/'.$a->id; ?>" class="btn btn-sm btn-warning"><i class="fa fa-wrench"></i></a>
                <a href="<?php echo base_url().'kelas/anggota_meninggal_hapus/'.$a->id; ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
            <?php
          }
