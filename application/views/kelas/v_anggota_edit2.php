...
Swal.fire(
  ...
  'error'
      ...
      <a href="<?php echo base_url().'kelas/anggota' ?>" class='btn btn-sm btn-light btn-outline-dark  pull-right'><i class="fa fa-arrow-left"></i> Kembali</a>
      <br/>
      <br/>

      <?php foreach($anggota as $a){ ?>
        <form method="post" action="<?php echo base_url().'kelas/anggota_update'; 
      
      ?>">
        <input type="hidden"  name="id" value="<?php echo $a->id; ?>">
        <div class="form-group">
          <label class="font-weight-bold" for="no_anggota">Nomor Anggota</label>
          <input type="text" class="form-control" name="no_anggota" placeholder="Masukkan Nomor Anggota" required="required" value="<?php echo $a->no_anggota; ?>">
        </div>
