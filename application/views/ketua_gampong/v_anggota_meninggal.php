 ...
 <div class="row mt-2">
            <div class="col-12">
                <div class="card-inline">
                    ...
                    <a href="<?php echo base_url().'ketua_gampong/meninggal_laporan' ?>" class='btn btn-sm btn-warning pull-right'><i class="fa fa-file-pdf-o "></i> Rekap Data Jamaah Meninggal</a>
                </div>
      <br/>
      <br/>
