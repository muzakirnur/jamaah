  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      if(isset($_GET['tanggal_mulai']) && isset($_GET['tanggal_sampai'])){
        ...
        ?>
        <a href="<?php echo base_url().'meninggal/export_pdf_meninggal_ketua_gampong/?tanggal_mulai='.$mulai.'&tanggal_sampai='.$sampai.'&gampong='.$this->session->userdata('ketua_gampong')?>" class='btn btn-sm btn-warning pull-right'><i class="fa fa-print"></i> Print Data</a>
        <?php
      }
      ?>
      <br/>
