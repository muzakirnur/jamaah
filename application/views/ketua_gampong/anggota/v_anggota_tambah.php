...
<div class="container">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo base_url().'ketua_gampong/anggota_tambah_aksi'; ?>">
      ...
      <p><input type='radio' name='jenis_kelamin' value='P' />Perempuan</p>
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="kecamatan" readonly value="<?php echo $this->session->userdata('kecamatan'); ?> ">
        </div>
        <div class="form-group">
          <label class="font-weight-bold" for="gampong">Gampong</label>
          <input class="form-control" name="gampong" readonly value="<?php echo $this->session->userdata('ketua_gampong'); ?> ">
        </div>
