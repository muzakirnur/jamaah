  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <?php foreach($anggota as $a){ ?>
        <form method="post" action="<?php echo base_url().'ketua_gampong/anggota_update'; ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="gampong" placeholder="Masukkan Nama Gampong"  readonly required="required" value="<?php echo $a->gampong; ?>">
        </div>
        <div class="form-group">
          <label class="font-weight-bold" for="kecamatan">Kecamatan</label>
          <input type="text" class="form-control" name="kecamatan" placeholder="Masukkan Nama Kecamatan" readonly required="required" value="<?php echo $a->kecamatan; ?>">
        </div>
        <div class="form-group">
          <label class="font-weight-bold" for="kabupaten">Kabupaten</label>
          <input type="text" class="form-control" name="kabupaten" placeholder="Masukkan Nama Kabupaten" readonly required="required" value="<?php echo $a->kabupaten; ?>">
        </div>
